    ...
    <section className="py-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-white font-heading mb-8">Education and Training</h2>
        </div>
          ...
          <div className="relative bg-black/40 backdrop-blur-sm rounded-3xl p-8 border border-purple-500/20">
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-white mb-4 font-heading">FREE DEVELOPER TRAINING</h3>
